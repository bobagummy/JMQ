...
public class Targeting : MonoBehaviour {
    ...
    public IEnumerator StartTargeting(int theNumChoices, Action<int> theSelectedChoice, List<GameObject> theTargets) {
        ...
        while (isDismissed == false) {
            ...
            yield return StartCoroutine(WaitForChoice(theNumChoices, value => theSelectedChoice(value), theTargets));
    ...
    public IEnumerator WaitForChoice(int theNumChoices, Action<int> theSelectedChoice, List<GameObject> theTargets) {
