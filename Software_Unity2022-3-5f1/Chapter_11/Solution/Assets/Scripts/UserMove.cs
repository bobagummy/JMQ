...
public class UserMove : MonoBehaviour {
    ...
    void Update() {
        ...
        if (isInputEnabled == true) {
            ...
            //move group
            Group heroes = gameObject.GetComponent<Group>();
            heroes.UpdatePos(speed, _newDir);
        }
    } 
    ...
    private void CheckUserInput() {
        ...
        */
		...
		if (
            ...
            //animation
            //if not already set
            if (animator.currentAnim.animName != "MoveUp") {

                //update animation
                animator.SetUpAnimationWithName("MoveUp", 6.0f);
            }
		...
		//move down
            ...
            //animation
            //if not already set
            if (animator.currentAnim.animName != "MoveDown") {

                //update animation
                animator.SetUpAnimationWithName("MoveDown", 6.0f);
            }
		...
		//move left
            ...
            //animation
            //if not already set
            if (animator.currentAnim.animName != "MoveLeft") {

                //update animation
                animator.SetUpAnimationWithName("MoveLeft", 6.0f);
            }
		...
		//move right
            ...
            //animation
            //if not already set
            if (animator.currentAnim.animName != "MoveRight") {

                //update animation
                animator.SetUpAnimationWithName("MoveRight", 6.0f);
            }
