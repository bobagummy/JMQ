    ...
    private IEnumerator OnTriggerEnter2D(Collider2D theCollider) {
        ...
        switch (tag) {
            ...
            case "Stairs":
                ...
                StateManager.Instance.SwitchSceneTo(SceneManager.GetActiveScene().name);           
            ...
            case "Knight":
                ...
                if (choice == 0) {
                    ...
                    if (knightName == "Red Knight") {
                        ...
                        StateManager.Instance.SwitchSceneTo("DungeonRed");
                    }
                    else if (knightName == "Green Knight") {

                        //switch to dungeon scene
                        StateManager.Instance.SwitchSceneTo("DungeonGreen");
                    }
                    else if (knightName == "Blue Knight") {

                        //switch to dungeon scene
                        StateManager.Instance.SwitchSceneTo("DungeonBlue");
                    }
                }
            ...
            case "Dragon":
                ...
                StateManager.Instance.SwitchSceneTo(interactionName);
